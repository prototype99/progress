...
HOMEPAGE="https://www.mercurial-scm.org/ https://pypi.python.org/pypi/Mercurial"
SRC_URI=""
EHG_REPO_URI="https://selenic.com/repo/hg"
EHG_REVISION="@"
...
src_prepare() {
	...
	# https://bz.mercurial-scm.org/show_bug.cgi?id=4083
	rm tests/test-subrepo-svn.t
	# https://bz.mercurial-scm.org/show_bug.cgi?id=4084
	rm tests/test-clone-cgi.t
	rm tests/test-hgweb-commands.t
	rm tests/test-push-cgi.t
	# https://bz.mercurial-scm.org/show_bug.cgi?id=5146
	rm tests/test-clonebundles.t
	# https://bz.mercurial-scm.org/show_bug.cgi?id=5147
	rm tests/test-debugextensions.t
	# https://bz.mercurial-scm.org/show_bug.cgi?id=5148
	rm tests/test-gpg.t
