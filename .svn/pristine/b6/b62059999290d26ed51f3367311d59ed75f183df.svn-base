...
# @SUPPORTED_EAPIS: 0 1 2 3 4 4-python 5 5-progress 6
...
subversion_bootstrap() {
	[[ ${EAPI} =~ ^(0|1|2|3|4|4-python|5|5-progress)$ ]] || die "${FUNCNAME} is removed from subversion.eclass in EAPI 6 and later"
