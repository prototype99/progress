...
HOMEPAGE="https://www.riverbankcomputing.com/software/sip/intro https://pypi.python.org/pypi/SIP"
...
if [[ "${PV}" == "9999" ]]; then
	...
	SRC_URI="https://www.riverbankcomputing.com/static/Downloads/sip4/${MY_P}.tar.gz
		https://people.apache.org/~Arfrever/gentoo/${MY_P}.tar.gz"
	S="${WORKDIR}/${MY_P}"
else
