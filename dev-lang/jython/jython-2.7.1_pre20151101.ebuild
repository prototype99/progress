...
java_prepare() {
	...
	java-pkg_jar-from --into extlibs jnr-constants jnr-constants.jar jnr-constants-0.8.8.jar
	java-pkg_jar-from --into extlibs jnr-netdb-1.0 jnr-netdb.jar jnr-netdb-1.1.4.jar
	java-pkg_jar-from --into extlibs jnr-posix-3.0 jnr-posix.jar jnr-posix-3.0.17.jar
	...
	java-pkg_jar-from --into extlibs netty-buffer netty-buffer.jar netty-buffer-4.0.31.Final.jar
	java-pkg_jar-from --into extlibs netty-codec netty-codec.jar netty-codec-4.0.31.Final.jar
	java-pkg_jar-from --into extlibs netty-common netty-common.jar netty-common-4.0.31.Final.jar
	java-pkg_jar-from --into extlibs netty-handler netty-handler.jar netty-handler-4.0.31.Final.jar
	java-pkg_jar-from --into extlibs netty-transport netty-transport.jar netty-transport-4.0.31.Final.jar
	...
	java-pkg_jar-from --build-only --into extlibs jnr-ffi-2 jnr-ffi.jar jnr-ffi-2.0.4.jar
