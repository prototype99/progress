...
if [[ "${CATEGORY}/${PN}" == "dev-python/twisted"* ]]; then
	...
	HOMEPAGE="https://twistedmatrix.com/trac/ https://pypi.python.org/pypi/Twisted"
	SRC_URI="https://twistedmatrix.com/Releases/${MY_PACKAGE}/$(get_version_component_range 1-2 ${MY_PV})/${MY_P}.tar.bz2"
