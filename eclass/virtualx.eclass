...
# @SUPPORTED_EAPIS: 4 4-python 5 5-progress 6 7
...
virtualmake() {
	...
	if [[ -n ${maketype} ]]; then
		[[ ${EAPI} =~ ^(4|4-python|5|5-progress)$ ]] || die "maketype is banned in EAPI > 5"
