...
# @MAINTAINER:
# systemd@gentoo.org
# @SUPPORTED_EAPIS: 0 1 2 3 4 4-python 5 5-progress 6 7
...
case ${EAPI:-0} in
	0|1|2|3|4|4-python|5|5-progress|6|7) ;;
	*) die "${ECLASS}.eclass API in EAPI ${EAPI} not yet established."
esac

if [[ ${EAPI:-0} =~ ^(0|1|2|3|4|4-python|5|5-progress|6)$ ]]; then
...
systemd_get_unitdir() {
	[[ ${EAPI} =~ ^(0|1|2|3|4|4-python|5|5-progress)$ ]] || die "${FUNCNAME} is banned in EAPI ${EAPI}, use systemd_get_systemunitdir instead"
...
systemd_with_unitdir() {
	[[ ${EAPI:-0} =~ ^(0|1|2|3|4|4-python|5|5-progress)$ ]] || die "${FUNCNAME} is banned in EAPI ${EAPI}, use --with-${1:-systemdsystemunitdir}=\"\$(systemd_get_systemunitdir)\" instead"
...
systemd_with_utildir() {
	[[ ${EAPI:-0} =~ ^(0|1|2|3|4|4-python|5|5-progress)$ ]] || die "${FUNCNAME} is banned in EAPI ${EAPI}, use --with-systemdutildir=\"\$(systemd_get_utildir)\" instead"
